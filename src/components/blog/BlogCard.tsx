...
export function BlogCard({ post }: BlogCardProps) {
  ...
  return (
    <Card className="group h-full w-full overflow-hidden border-gray-100 py-0 shadow-none transition-all dark:border-gray-800">
      ...
      <CardContent className="px-5 pt-5">
        <div className="space-y-2.5">
          <Link href={`/blog/${slug}`}>
            <h3 className="group-hover:text-primary line-clamp-2 text-lg leading-tight font-semibold md:text-xl">
              {title}
            </h3>
          </Link>
